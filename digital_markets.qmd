...
It becomes even more difficult to define, as many outputs, like social media, from this market are provided “without consumer cost.”[^1] Additionally, digital markets are in constant flux, fueled by societal shifts in the aftermath of the COVID-19 pandemic and the accelerating adoption of artificial intelligence (AI).
...
This project visualizes the information provided by the Bureau of Economic Analysis’s report “U.S. Digital Economy: New and Revised Estimates, 2017–2022” and explores trends. For more on the methodology behind their calculations visit the [BEA](https://www.bea.gov/data/special-topics/digital-economy).\

<br/><br/> \#### Here's how I loaded and prepared the data.
